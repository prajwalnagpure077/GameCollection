...
namespace Chess.Game {
	public class GameManager : MonoBehaviour {
		...
		void NotifyPlayerToMove () {
			...
			{
				ChessMatchManager.instance.GameDone(ChessGameState.lose);
			}
		}
		...
		void PrintGameResult (Result result) {
			...
			if (result == Result.Playing) {
				...
				ChessMatchManager.instance.GameDone(ChessGameState.won);
				resultUI.text = "Checkmate!";
			} else if (result == Result.FiftyMoveRule) {
				ChessMatchManager.instance.GameDone(ChessGameState.draw);
				resultUI.text = "Draw";
